...
export interface DirectusFile {
   ...
   * Type in database: no column
   */
  associated_resources: ResourceFile[] | null;
...
export interface ExamDatum {
   ...
   * Type in database: character varying
   */
  type: 'first' | 'second' | 'midterm' | 'final' | 'quiz' | 'quiz1' | 'quiz2' | 'quiz3' | 'quiz4' | 'quiz5' | 'quiz6';
}
...
export interface NoteDatum {
   ...
   * Type in database: character varying
   */
  type: 'slides' | 'summary' | 'project' | 'assignment' | 'other';
}
...
export interface Report {
   ...
   * Type in database: character varying
   */
  type: 'unrelated' | 'incorrect' | 'other';
}
...
export interface Resource {
   ...
   * Type in database: integer
   */
  exam_data: ExamDatum | ExamDatum['id'] | null;
   ...
   * Type in database: integer
   */
  note_data: NoteDatum | NoteDatum['id'] | null;
   ...
   * Type in database: uuid
   */
  user_created: DirectusUser | DirectusUser['id'];
...
export interface ResourceFile {
   ...
   * Type in database: uuid
   */
  directus_files_id: DirectusFile | DirectusFile['id'];
...
export type ItemIn<CollectionKey extends CollectionName> = Schema[CollectionKey] extends (infer Item extends Record<
  string,
  any
>)[]
  ? Item
