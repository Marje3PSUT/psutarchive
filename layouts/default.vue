...
const { data, pending } = await useLazyAsyncData(
  async (): Promise<StrapiResponse<AnnouncementAttributes>> => await $baseApi(`announcements`, { cache: true }),
);
...
<template>
  <div :data-theme="useTheme().value" :dir="head.htmlAttrs?.dir" :lang="head.htmlAttrs?.lang" class="flex flex-col">
