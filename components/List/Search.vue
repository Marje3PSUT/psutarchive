  ...
  <form class="mt-4" @submit.prevent>
    <div class="search-input">
      ...
      <input
        ...
        type="search"
        list="search-data"
        :placeholder="props.searchPlaceholder ? props.searchPlaceholder : $t('lists.search') + '...'"
        class="input w-full focus:outline-none"
        name="q"
        autocomplete="off"
      />
      <Icon name="ion:search-outline" size="36" class="search-icon" />
    </div>
    <div v-if="searchError" class="alert flex alert-error w-max h-12 mx-auto mt-2">
      <svg
