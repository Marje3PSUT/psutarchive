...
<template>
  <div class="list-component container">
    ...
    <div v-if="heading || headingLink" class="flex justify-between flex-wrap items-center my-4 gap-2">
      ...
      <NuxtLink v-if="props.headingLink" :to="headingLink.to" class="btn btn-sm btn-ghost p-1 ms-auto">
        {{ headingLink.text }}
        <Icon
    ...
    <!-- Tabs -->
    <div v-if="props.tabs.length" class="tabs tabs-boxed justify-center gap-4 bg-transparent mb-8">
      <button
        v-for="(tab, i) in props.tabs"
        :key="i"
        class="tab"
        :class="{ 'tab-active !bg-secondary !text-secondary-content': activeTab === i, indicator: tab.indicator }"
    ...
    <div v-if="pending" class="flex justify-center">
      <div class="loading loading-infinity loading-lg" />
    </div>
